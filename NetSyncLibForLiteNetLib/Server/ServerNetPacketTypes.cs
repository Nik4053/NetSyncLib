...
namespace NetSyncLibForLiteNetLib.Server
{
    public static class ServerNetPacketTypes
    {
        ...
        public static void ReadUpdateController(NetDataReader reader, NetPeer peer, NetSyncDeliveryMethod deliveryMethod = NetSyncDeliveryMethod.Unreliable)
        {
        ...
        public static void ReadMessage(NetDataReader reader, NetPeer peer = null, NetSyncDeliveryMethod deliveryMethod = NetSyncDeliveryMethod.Unreliable)
        {
        ...
        public static void ReadCloneAll(NetDataReader reader, NetPeer peer = null, NetSyncDeliveryMethod deliveryMethod = NetSyncDeliveryMethod.Unreliable)
        {
